...
elseif(SYSTEM_MACOSX)
    ...
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(arm64|aarch64)$" OR CMAKE_OSX_ARCHITECTURES MATCHES "^(arm64|aarch64)$")
        set(MongoDB_MOZJS_ARCH aarch64)
    else()
        set(MongoDB_MOZJS_ARCH x86_64)
    endif()
    list(APPEND MongoDB_INCLUDE_DIRS
        ${MongoDB_DIR}/src/third_party/${MOZJS_VER}/platform/${MongoDB_MOZJS_ARCH}/macOS/include)
