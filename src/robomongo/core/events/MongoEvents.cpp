...
namespace Robomongo
{
    ...
    R_REGISTER_EVENT(LoadDatabaseStorageStatsRequest)
    R_REGISTER_EVENT(LoadDatabaseStorageStatsResponse)
    ...
    R_REGISTER_EVENT(ExportQueryRequest)
    R_REGISTER_EVENT(ExportQueryResponse)
    R_REGISTER_EVENT(DocumentListLoadedEvent)
    R_REGISTER_EVENT(QueryResultExportLoadedEvent)
